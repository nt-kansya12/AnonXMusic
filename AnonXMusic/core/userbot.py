...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER(__name__).info(f"Starting Assistants Adira...")
        if config.STRING1:
            await self.one.start()
            try:
                await self.one.join_chat("Berlinmusic_support")
                await self.one.join_chat("Asupan_viral18plus")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(config.LOGGER_ID, "Assistant Adira Started")
            except:
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("Asupan_viral18plus")
            except:
                pass
            assistants.append(2)
            try:
                await self.two.send_message(config.LOGGER_ID, "Assistant Adira Started")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("Asupan_viral18plus")
            except:
                pass
            assistants.append(3)
            try:
                await self.three.send_message(config.LOGGER_ID, "Assistant Adira Started")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("Asupan_viral18plus")
            except:
                pass
            assistants.append(4)
            try:
                await self.four.send_message(config.LOGGER_ID, "Assistant Adira Started")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("Asupan_viral18plus")
            except:
                pass
            assistants.append(5)
            try:
                await self.five.send_message(config.LOGGER_ID, "Assistant Adira Started")
            except:
                LOGGER(__name__).error(
